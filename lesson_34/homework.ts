...
type subject ='The World History'|'History of Rome'|'biology'|'chemistry'|'mathematics'|'geometry'|'trigonometry'|'ui'|'graphic design'|'ux'
type faculties={
    id:number,
    faculty:string,
    subjects:subject[]
...
type genre='Action'|'Sci-Fi'|'Adventure'|'Fantasy'|'Drama'
type movie={
    id:number,
    title:string,
    year:number,
